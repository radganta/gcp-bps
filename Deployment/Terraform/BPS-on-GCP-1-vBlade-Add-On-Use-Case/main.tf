...
locals {
	...
	GCP_VCONTROLLER_CUSTOM_IMAGE_FAMILY_NAME = "ixia-breakingpoint-virtual-controller-9-10-110-update3"
	...
	GCP_VBLADE_CUSTOM_IMAGE_FAMILY_NAME = "ixia-breakingpoint-virtual-blade-9-10-110-update3"
